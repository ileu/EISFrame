...
def main():
    ...
    file2 = (
        r"\20211004_B8-P2_RT-Water-1w_HT400C_Li-3mm-300C-30min_FCandPT_01_PEIS_C04.mpr"
    )
    file3 = (
        r"\20211006_B8-P2_Water-46C-1w_HT400C_Li-3mm-300C-30min_FCandPT_01_PEIS_C08.mpr"
    )
