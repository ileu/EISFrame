...
files = [cell2]  # , cell2, cell3, cell4, cell5]
...
def cycles():
    for i, file in enumerate(files):
        ...
        for n, cycle in enumerate(data):
            ...
            initial_guess['Wss1_R'] = (tot_imp - initial_guess['R3']) * 0.5
            initial_guess['Wss2_R'] = (tot_imp - initial_guess['R3']) * 0.5
            print("fit1 done")
