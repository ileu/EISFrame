...
class CPE(Element2Term):
    ...
    def __init__(self, *d, **kwargs):
        ...
        capgap = 0.25
        offset = 0.5
        self.segments.append(Segment([(0, 0), (offset, 0), (capgap, -height), gap,
                                      (offset, 0), gap, (offset + capgap, 0), (2 * offset, 0)]))
        self.segments.append(Segment([(offset, 0), (capgap, height), gap, (offset, 0), gap,
                                      (offset + capgap, 0)]))
        self.segments.append(Segment([(offset + capgap, 0), (offset, height), gap,
                                      (offset + capgap, 0)]))
        self.segments.append(Segment([(offset + capgap, 0),  (offset, -height), gap,
                                      (offset + capgap, 0)]))
