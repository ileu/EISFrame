...
from eisplottingtool.parser.CircuitComponents import (
    Resistor,
    Capacitor,
    CPE,
    Warburg,
...
test_components = [
    ...
    pytest.param(CPE, "CPE", 0.00801703 - 0.0506175j, id="CPE"),
    pytest.param(
        Warburg,
        "W",
...
@pytest.mark.parametrize("comp, symbol, expected", test_components)
